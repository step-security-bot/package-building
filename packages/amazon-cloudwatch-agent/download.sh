...
# shellcheck disable=2154
wget "https://amazoncloudwatch-agent-us-east-2.s3.us-east-2.amazonaws.com/ubuntu/amd64/${PKG_VER}/amazon-cloudwatch-agent.deb" \
    --output-document "${GITHUB_WORKSPACE}/packages/${PKG_NAME}/dist/${PKG_NAME}_${PKG_VER}-1_amd64.deb"

# linux/arm64 (ARM64) DEB
# shellcheck disable=2154
wget "https://amazoncloudwatch-agent-us-east-2.s3.us-east-2.amazonaws.com/ubuntu/arm64/${PKG_VER}/amazon-cloudwatch-agent.deb" \
